...
namespace EZCameraShake
{
    ...
    public class CameraShaker : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            //transform.localPosition = player.transform.localPosition + posAddShake + RestPositionOffset;
            //transform.localEulerAngles = player.transform.localEulerAngles + rotAddShake + RestRotationOffset;
        }
